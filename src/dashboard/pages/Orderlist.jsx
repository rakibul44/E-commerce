              ...
              <div className=" w-full md:w-2/3">
                ...
                {modalType === "view" && (
                  <>
                    ...
                    <p><strong>Color:</strong> {selectedOrder.productColor}</p>
                    <p><strong>Price:</strong> {selectedOrder.price}</p>
                    <p><strong>Quantity:</strong> {selectedOrder.quantity}</p>
                    <p><strong>Total Price:</strong> {selectedOrder.totalPrice}</p>

                    {/* Adding dummy content to make the modal scrollable */}
                    <div className="mt-4">
                      <h5 className="font-semibold">More Details</h5>
                      <p>Here is some dummy content that will make the modal longer.</p>
                      <p>Keep adding more content here to simulate a longer view modal.</p>
